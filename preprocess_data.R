...
listH<-prune_samples(sample_sums(pHalo)<.01,pHalo) # list samples with <1% Halomonas
...
juvTreat<-subset_samples(juv,!Subproject%in%c("BBEZadults","USAadult","1feed","2feeds","Refused"))